...
import { School, BookOpen, Award, Users, GraduationCap, Target, Microscope, TrendingUp } from 'lucide-react';
...
const categories = [
  ...
  { id: 'sma-kelas-10', name: 'SMA Kelas 10', icon: GraduationCap, courses: 10 },
  { id: 'sma-kelas-11-ipa', name: 'SMA Kelas 11-12 IPA', icon: Microscope, courses: 32 },
  { id: 'sma-kelas-11-ips', name: 'SMA Kelas 11-12 IPS', icon: TrendingUp, courses: 32 },
