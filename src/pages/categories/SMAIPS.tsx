...
const SMAIPS = () => {
  ...
  // Filter kursus untuk kategori SMA IPS
  const smaIPSCourses = mockCourses.filter(course => 
    course.category === "Sekolah Menengah Atas (SMA) - IPS"
  );
        ...
        <section className="bg-gray-50 py-16">
          <div className="container">
            ...
            <p className="text-lg text-gray-600 text-center max-w-3xl mx-auto">
              Kursus pembelajaran untuk siswa SMA jurusan IPS meliputi Ekonomi, Geografi, Sejarah, dan Sosiologi
            </p>
          </div>
        </section>
